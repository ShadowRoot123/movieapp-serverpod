...
import 'movie_details.dart' as _i4;
import 'package:movieapp_client/src/protocol/movie.dart' as _i5;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.MovieDetail) {
      return _i4.MovieDetail.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i4.MovieDetail?>()) {
      return (data != null ? _i4.MovieDetail.fromJson(data) : null) as T;
    }
    if (t == List<_i5.Movie>) {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'MovieDetail') {
      return deserialize<_i4.MovieDetail>(data['data']);
    }
